<?php
if (!isset($data_peminjaman)) {
    header("Location: " . BASEURL . "/index.php?url=admin/monitoring");
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Monitoring Peminjaman - Admin Perpustakaan</title>
        ...
        <div class="main-content">
            <div class="admin-header">
                <div class="section-title">
                    <h2>📖 Monitoring Peminjaman</h2>
                </div>
                <div style="display: flex; gap: 16px; align-items: center;">
                    <form method="GET" action="index.php" style="display: flex; gap: 8px;">
                        <input type="hidden" name="url" value="admin/monitoring">
                        ...
                        <?php if(isset($_GET['search']) && trim($_GET['search']) !== ''): ?>
                            <a href="index.php?url=admin/monitoring" class="btn" style="background: #f1f5f9; color: var(--text-main); padding: 8px 16px; text-decoration: none; border-radius: 6px;">Reset</a>
                        <?php endif; ?>
                    </form>
            ...
            <h3 style="margin-bottom: 16px; color: var(--text-main);">🕒 Menunggu Persetujuan</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index.php?url=admin/tolakPeminjaman&id=<?= $loan['id_peminjaman']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Tolak peminjaman ini?')">Tolak</a>
                            </td>
                        </tr>
            ...
            <h3 style="margin-top: 32px; margin-bottom: 16px; color: var(--text-main);">📖 Peminjaman Aktif</h3>
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if(empty($data_dipinjam)): ?>
                            <tr><td colspan="5" style="text-align: center;">Tidak ada peminjaman aktif.</td></tr>
                        <?php else: foreach ($data_dipinjam as $loan): ?>
                        <tr>
                            <td>
                                <strong><?= $loan['nama_siswa']; ?></strong><br>
                                <small><?= $loan['judul_buku']; ?></small>
                            ...
                            <td><span class="badge badge-dipinjam"><?= $loan['STATUS']; ?></span></td>
                            <td>
                                <a href="index.php?url=admin/kembalikanBuku&id=<?= $loan['id_peminjaman']; ?>" class="btn btn-sm btn-success">Kembalikan</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; ?>
                    </tbody>
            ...
            <h3 style="margin-top: 32px; margin-bottom: 16px; color: var(--text-main);">📜 Riwayat Selesai & Ditolak</h3>
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
