<?php
if (!isset($data_dipinjam)) {
    header("Location: " . BASEURL . "/index.php?url=admin/pinjamanAktif");
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Peminjaman Aktif - Admin Perpustakaan</title>
            ...
            <div class="admin-header">
                ...
                <div style="display: flex; gap: 16px; align-items: center;">
                    <form method="GET" action="index.php" style="display: flex; gap: 8px;">
                        <input type="hidden" name="url" value="admin/pinjamanAktif">
                        ...
                        <?php if(isset($_GET['search']) && trim($_GET['search']) !== ''): ?>
                            <a href="index.php?url=admin/pinjamanAktif" class="btn" style="background: #f1f5f9; color: var(--text-main); padding: 8px 16px; text-decoration: none; border-radius: 6px;">Reset</a>
                        <?php endif; ?>
                    </form>
